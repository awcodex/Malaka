<?php
require_once dirname( __FILE__ ) . '/aw-plugin/class-tgm-plugin-activation.php';
...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		// array(
			...
			// 'source'             => get_stylesheet_directory() . '/aw-plugin/plugins/yoast-seo.zip', // The plugin source.
			// 'required'           => true, // If false, the plugin is only 'recommended' instead of required.
			// 'version'            => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
			// 'force_installation'   => true, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
...
//		),
		...
		array(
			'name'                => 'Events Manager',
			'slug'                => 'event-manager',
			'source'              => get_stylesheet_directory() . '/aw-plugin/plugins/events-manager.zip',
		...
		array(
			'name'                => 'Contact Form 7',
			'slug'                => 'contact-form-7',
			'source'              => get_stylesheet_directory() . '/aw-plugin/plugins/contact-form-7.zip',
			'force_activation'    => true,
			'force_deactivation'  => true, 
			'required'            => true,
			'dismissable'		  => false,
